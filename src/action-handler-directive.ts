...
// DONE You need to replace all instances of "action-handler-donder-badge" with "action-handler-<your card name>"
customElements.define('action-handler-donder-badge', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-donder-badge')) {
    return body.querySelector('action-handler-donder-badge') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-donder-badge');
