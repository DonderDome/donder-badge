 ...
 */}function Y(t){return X({...t,state:!0})}var Q="[^\\s]+";function tt(t,e){for(var i=[],o=0,n=t.length;o<n;o++)i.push(t[o].substr(0,e));return i}var et=function(t){return function(e,i){var o=i[t].map((function(t){return t.toLowerCase()})),n=o.indexOf(e.toLowerCase());return n>-1?n:null}};function it(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i];for(var o=0,n=e;o<n.length;o++){var s=n[o];for(var r in s)t[r]=s[r]}return t}var ot=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],nt=["January","February","March","April","May","June","July","August","September","October","November","December"],st=tt(nt,3),rt={dayNamesShort:tt(ot,3),dayNames:ot,monthNamesShort:st,monthNames:nt,amPm:["am","pm"],DoFn:function(t){return t+["th","st","nd","rd"][t%10>3?0:(t-t%10!=10?1:0)*t%10]}},at=(it({},rt),function(t){return+t-1}),lt=[null,"[1-9]\\d?"],ct=[null,Q],dt=["isPm",Q,function(t,e){var i=t.toLowerCase();return i===e.amPm[0]?0:i===e.amPm[1]?1:null}],ht=["timezoneOffset","[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?",function(t){var e=(t+"").match(/([+-]|\d\d)/gi);if(e){var i=60*+e[1]+parseInt(e[2],10);return"+"===e[0]?i:-i}return 0}];et("monthNamesShort"),et("monthNames");var ut,pt;!function(){try{(new Date).toLocaleDateString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleString("i")}catch(t){return"RangeError"===t.name}}(),function(){try{(new Date).toLocaleTimeString("i")}catch(t){return"RangeError"===t.name}}(),function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(ut||(ut={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(pt||(pt={}));var gt=function(t,e,i,o){o=o||{},i=null==i?{}:i;var n=new Event(e,{bubbles:void 0===o.bubbles||o.bubbles,cancelable:Boolean(o.cancelable),composed:void 0===o.composed||o.composed});return n.detail=i,t.dispatchEvent(n),n};function vt(t){return void 0!==t&&"none"!==t.action}const mt={required:{icon:"tune",name:"Required",secondary:"Required options for this card to function",show:!0},actions:{icon:"gesture-tap-hold",name:"Actions",secondary:"Perform actions based on tapping/clicking",show:!1,options:{tap:{icon:"gesture-tap",name:"Tap",secondary:"Set the action to perform on tap",show:!1},hold:{icon:"gesture-tap-hold",name:"Hold",secondary:"Set the action to perform on hold",show:!1},double_tap:{icon:"gesture-double-tap",name:"Double Tap",secondary:"Set the action to perform on double tap",show:!1}}},appearance:{icon:"palette",name:"Appearance",secondary:"Customize the name, icon, etc",show:!1}};let _t=class extends Z{constructor(){super(...arguments),this._initialized=!1}setConfig(t){this._config=t,this.loadCardHelpers()}shouldUpdate(){return this._initialized||this._initialize(),!0}get _name(){var t;return(null===(t=this._config)||void 0===t?void 0:t.name)||""}get _entity(){var t;return(null===(t=this._config)||void 0===t?void 0:t.entity)||""}get _show_warning(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_warning)||!1}get _show_error(){var t;return(null===(t=this._config)||void 0===t?void 0:t.show_error)||!1}get _tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.tap_action)||{action:"more-info"}}get _hold_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.hold_action)||{action:"none"}}get _double_tap_action(){var t;return(null===(t=this._config)||void 0===t?void 0:t.double_tap_action)||{action:"none"}}render(){if(!this.hass||!this._helpers)return H``;this._helpers.importMoreInfoControl("climate");const t=Object.keys(this.hass.states).filter((t=>"sun"===t.substr(0,t.indexOf("."))));return H`
    ...
    `}_handleMoreInfoAction(t,e){t.stopPropagation(),this.hass.callService("browser_mod","more_info",{entity:e.entity})}_handleLightAction(t,e){const{entity:i,entity_data:o,entity_type:n}=e;switch(t.stopPropagation(),n){case"boolean":console.log("boolean",i,o),this.hass.callService("input_boolean","toggle",{entity_id:i});break;case"lights":console.log("lights",i,o),this.hass.callService("light","toggle",Object.assign({entity_id:i},o));break;case"switch":console.log("switch",i,o),this.hass.callService("switch","toggle",{entity_id:i})}}renderClimateBadge(t){const{entity:e}=t,{state:i,attributes:o}=this.hass.states[e];return H`
      ...
      >
        <ha-icon icon=${{heat_cool:"mdi:sun-snowflake-variant",heat:"mdi:fire",cool:"mdi:snowflake",auto:"mdi:autorenew",dry:"mdi:water-percent",off:"mdi:power"}[i]}></ha-icon>
        <div>${o.current_temperature}${o.temperature_unit}</div>
      </ha-card>
    `}renderLightBadge(t){const{entity:e}=t,{state:i}=this.hass.states[e];return H`
      <ha-card
        @action=${e=>this._handleLightAction(e,t)}
        .actionHandler=${bt({hasHold:vt(this.config.hold_action),hasDoubleClick:vt(this.config.double_tap_action)})}
        tabindex="0"
    ...
    `}renderBadge(t){const{entity_type:e}=t;return"climate"===e?this.renderClimateBadge(t):"light"===e?this.renderLightBadge(t):"shutter"===e?this.renderShutterBadge(t):"gadget"===e?this.renderGadgetBadge(t):H`
    ...
    `}}t([X({attribute:!1})],wt.prototype,"hass",void 0),t([Y()],wt.prototype,"config",void 0),customElements.define("donder-badge",wt);export{wt as BoilerplateCard};
